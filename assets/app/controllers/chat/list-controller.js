(function( ng, app ){
	...
	app.controller(
		...
		function( $scope, $location, $q, requestContext, categoryService, chatService, _ ) {
		    ...
		    function applyRemoteData(category, chats) {

				$scope.category = category;
				$scope.pets = _.sortOnProperty( chats, "name", "asc" );
			...
			function loadRemoteData() {
				...
				var promise = $q.all(
					[
						...
						chatService.getChatsByCategoryID( $scope.categoryID )
					]
				);
			...
			var renderContext = requestContext.getRenderContext( "standard.chat.list", "categoryID" );
